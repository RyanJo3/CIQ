...
if not os.path.exists(font_path):
    ...
    try:
        ...
        with col1:
            ...
            data['발생월'].value_counts().plot.pie(autopct='%1.1f%%', startangle=90, ax=ax1, fontsize=25)
            ax1.set_ylabel('')
            st.pyplot(fig1)
        ...
        with col2:
            ...
            data['보고 구분'].value_counts().plot.pie(autopct='%1.1f%%', startangle=90, ax=ax5, fontsize=25)
            ax5.set_ylabel('')
            st.pyplot(fig5)
